...
namespace QNZ.TestUI.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,Title,Summary,Body,Author,Thumbnail,Pubdate,ViewCount,Active,CategoryId,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate")] Article article)
        //{
