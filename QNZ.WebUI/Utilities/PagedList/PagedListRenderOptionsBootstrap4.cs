namespace QNZCMS.Utilities.PagedList
{
    ...
    public partial class PagedListRenderOptions
    {
        ...
        private const string DefaultLinkToPreviousPageFormat = "Ç°Ò³";

        private const string DefaultLinkToNextPageFormat = "ºóÒ³";

        private const string DefaultLinkToFirstPageFormat = "Ê×Ò³";

        private const string DefaultLinkToLastPageFormat = "Î²Ò³";
