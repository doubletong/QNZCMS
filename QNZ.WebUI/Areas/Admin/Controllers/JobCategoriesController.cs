...
namespace QNZCMS.Areas.Admin.Controllers
{
    ...
    public class JobCategoriesController : BaseController
    {
        ...
        public JobCategoriesController(YicaiyunContext context, IMapper mapper, IWebHostEnvironment hostingEnvironment)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<IActionResult> Index(string orderby, string sort, string keyword)
        {
            ...
            var query = _context.JobCategories.AsNoTracking().AsQueryable();
            ...
            vm.Categories = await query.ProjectTo<JobCategoryBVM>(_mapper.ConfigurationProvider).ToListAsync();
        ...
        public async Task<IActionResult> Copy(int id)
        {
            ...
            var article = await _context.JobCategories.AsNoTracking().FirstOrDefaultAsync(d => d.Id == id);
            ...
            _context.JobCategories.Add(article);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteMulti(int[] ids)
        {
            ...
            _context.JobCategories.RemoveRange(c);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var c = await _context.JobCategories.FirstOrDefaultAsync(d => d.Id == id);
            ...
            _context.JobCategories.Remove(c);
            await _context.SaveChangesAsync();
