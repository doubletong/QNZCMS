...
namespace QNZCMS.Areas.Admin.Controllers
{
    ...
    public class DocCategoriesController : BaseController
    {
        ...
        public async Task<IActionResult> Index(string orderby, string sort, string keyword)
        {
            ...
            var query = _context.DocCategories.AsNoTracking().AsQueryable();
            ...
            vm.Categories = await query.ProjectTo<DocCategoryBVM>(_mapper.ConfigurationProvider).ToListAsync();
        ...
        // POST: Admin/DocCategories/Edit/5
        ...
        public async Task<IActionResult> Copy(int id)
        {
            ...
            var article = await _context.DocCategories.AsNoTracking().FirstOrDefaultAsync(d => d.Id == id);
            ...
            _context.DocCategories.Add(article);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteMulti(int[] ids)
        {
            ...
            var c = await _context.DocCategories.Where(d => ids.Contains(d.Id)).ToListAsync();
            ...
            _context.DocCategories.RemoveRange(c);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var c = await _context.DocCategories.FirstOrDefaultAsync(d => d.Id == id);
            ...
            _context.DocCategories.Remove(c);
            await _context.SaveChangesAsync();
        ...
        private bool DocCategoryExists(int id)
        {
        ...
        {
            var query = _context.DocCategories.Where(d => d.Alias == alias).AsQueryable();
            if (id > 0)
            {
